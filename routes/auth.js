...
router.get('/google/callback',
    ...
    (req, res) => {
        ...
        // Redirigir con el token (puedes cambiarlo por tu frontend)
        ...
        <html>
            <body style="font-family: Arial, sans-serif; text-align: center; padding: 50px;">
                ...
                <ul style="text-align: left; max-width: 500px; margin: 0 auto;">
                    <li><a href="/api/products" target="_blank">GET /api/products</a> - Ver productos</li>
                    <li><a href="/api/categories" target="_blank">GET /api/categories</a> - Ver categorías</li>
                    <li><a href="/api/clients" target="_blank">GET /api/clients</a> - Ver clientes</li>
                    <li><a href="/api/sales" target="_blank">GET /api/sales</a> - Ver ventas</li>
                </ul>
